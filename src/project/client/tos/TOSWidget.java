...
public class TOSWidget extends VerticalPanel {
	public TOSWidget(final LoginInfo loginInfo) {
		...
		DOM.setStyleAttribute(area.getElement(), "border", "1px"); // removes
																	// border
		DOM.setStyleAttribute(area.getElement(), "width", "1150px"); // fixes
																		// size
																		// error
																		// on
																		// firefox
		...
		String text = "<b>Terms and Conditions of Service</b><br><br>"
				...
				"Last revised on August 3, 2012.<p><br> "
				+
